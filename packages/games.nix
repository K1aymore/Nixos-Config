...

{
  ...
  # flatpak override --user --env=MANGOHUD_CONFIG=fps_limit=135+114+0,arch,ram,vram,vkbasalt,gamemode,vulkan_driver,io_read,io_write,gpu_core_clock,gpu_mem_clock,gpu_fan,gpu_voltage,cpu_temp,gpu_temp com.valvesoftware.Steam
