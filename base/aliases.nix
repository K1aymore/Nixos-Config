...
in {
  ...
  environment.shellAliases = {
    ...
    steamhdr = "ENABLE_HDR_WSI=0 DXVK_HDR=1 gamescope -f -H 2160 --force-grab-cursor --mangoapp --hdr-enabled --hdr-debug-force-output --hdr-itm-enable -e -- env STEAM_FORCE_DESKTOPUI_SCALING=${systemSettings.scaling} steam";
